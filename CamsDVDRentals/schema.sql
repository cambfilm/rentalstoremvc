...
insert into movies (num_of_copies, available_copies, title, release_date) values (4, 4, 'Morsian yllÃ¤ttÃ¤Ã¤', '2017-07-21 15:43:40');
...
insert into movies (num_of_copies, available_copies, title, release_date) values (1, 1, 'Wedding Photographer, The (BrÃ¶llopsfotografen)', '2017-09-28 08:16:48');
